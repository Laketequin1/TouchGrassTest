def init(color, level, menu, player, Level, Booster, Platform, Enemy, Grass, GameText, Heart): # Restart level
    ...
    game_map = [Platform((80, 960)), Platform((120, 960)), Platform((160, 960)), Platform((200, 960)), Platform((240, 960)), Platform((280, 960)), Platform((320, 960)), Platform((360, 960)), Platform((400, 960)), Platform((440, 960)), Platform((480, 960)), Platform((520, 960)), Platform((560, 960)), Platform((600, 960)), Platform((640, 960)), Platform((680, 960)), Platform((720, 960)), Platform((760, 960)),
                ...
                Booster((0, 520), "down"), Platform((560, 520)), Platform((600, 520)), Platform((640, 520)),
                Booster((480, 480), "left"), Booster((520, 480), "left"), Booster((560, 480), "slow"), Booster((600, 480), "slow"), Booster((640, 480), "slow"), Platform((720, 480)), Platform((760, 480)),
                Platform((80, 440)), Platform((120, 440)), Platform((160, 440)), Platform((200, 440)), Platform((240, 440)), Platform((280, 440)), Platform((320, 440)), Platform((360, 440)), Platform((400, 440)), Platform((440, 440)), Platform((480, 440)), Platform((520, 440)), Platform((560, 440)), Platform((600, 440)), Platform((640, 440)), Platform((680, 440)), Platform((720, 440)), Platform((760, 440)),
                ...
                Grass((0, 40)), Enemy((80, 40)), Enemy((120, 40)), Enemy((160, 40)), Enemy((200, 40)), Enemy((240, 40)), Enemy((280, 40)), Enemy((320, 40)), Enemy((360, 40)), Booster((560, 40), "left"), Booster((600, 40), "left"), Booster((640, 40), "left"), Booster((680, 40), "left"), Booster((720, 40), "left"), Booster((760, 40), "left"),
                ...
                GameText((20, 725), "The faster you move,", color.GOLDENROD1),
                GameText((25, 675), "the larger the boost!", color.GOLDENROD1),
                
                GameText((200, 400), "Diamond shaped boosters", color.GOLDENROD1),
                GameText((260, 350), "make you slower!", color.GOLDENROD1),
