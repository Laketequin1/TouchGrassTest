...
MUSIC_DEFAULT_VOLUME = 0.1 # Default music volume
...
class player:
    ...
    def move(cls):
        ...
        cls.wind_sound.set_volume( ( abs(cls.velocity[0]) + abs(cls.velocity[1]) ) / (cls.MAX_VELOCITY * 1.6) + 0.2) # Set volume of wind higher if moving faster
...
class Booster:
    def __init__(self, pos, facing):
        ...
        self.wind_sound = Sound(1, 'swish', 0.035)
